  ...
  { -- Fuzzy Finder (files, lsp, etc)
    ...
    config = function()
      ...
      vim.keymap.set('n', '<leader>sF', function()
        builtin.find_files { hidden = true, no_ignore = true, no_ignore_parent = true, follow = true }
      ...
      vim.keymap.set('n', '<leader>sG', function()
        require('telescope').extensions.menufacture.live_grep { hidden = true, no_ignore = true, no_ignore_parent = true, follow = true }
      end, { desc = '[S]earch by [G]rep (including ignored)' })
      vim.keymap.set('n', '<leader>sd', builtin.diagnostics, { desc = '[S]earch [D]iagnostics' })
      vim.keymap.set('n', '<leader>sR', builtin.resume, { desc = '[S]earch [R]esume' })
      vim.keymap.set('n', '<leader>s.', builtin.oldfiles, { desc = '[S]earch Recent Files ("." for repeat)' })
      vim.keymap.set('n', '<leader><leader>', builtin.buffers, { desc = '[ ] Find existing buffers' })
      -- vim.keymap.set('n', '<leader>gs', builtin.git_status, { desc = '[S]earch [G]it status' })
